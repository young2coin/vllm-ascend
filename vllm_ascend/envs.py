...
env_variables: dict[str, Callable[[], Any]] = {
    ...
    # Whether to enable SHMEM MatmulAllReduce overlap kernel when tensor parallel is enabled.
    "VLLM_ASCEND_ENABLE_SHMEM_MATMUL_ALLREDUCE": lambda: bool(
        int(os.getenv("VLLM_ASCEND_ENABLE_SHMEM_MATMUL_ALLREDUCE", "0"))
    ),
